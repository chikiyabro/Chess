...
queen::queen(char a,int b,int c)
{
	setname(a);
	set_x(b);
	set_y(c);
}
bool rookivalid(int x1,int y1,int x2,int y2,keys ***& board)
{
...
bool bishopivalid(int x1,int y1,int x2, int y2,keys ***& board)
{
...
bool queen::valid_move(int x1,int y1,int x2,int y2,keys ***& board)
{
	if(!rookivalid(x1,y1,x2,y2,board))
	{
		if(!bishopivalid(x1,y1,x2,y2,board))
			return false;
	}
	return true;
}

bool queen::move(int x1,int y1,int x2,int y2,keys ***& board)
{
